...
//same logic as query tree
  ...
  while(getline(infile,line))
  {
    ...
    while(getline(linestream,recog,'/'))
    {
...
////////////////////////////////////////////////////////////////   STEP 2  
cout<<"2: "<<a_tree.PrintNumOfNodes()<<endl;
////////////////////////////////////////////////////////////////   STEP 3
...
cout<<"3b: "<<a_tree.AverageDepthLog2()<<endl;       
/////////////////////////////////////////////////////////////////  STEP 4
  ...
  cout<<"4a: "<<successful_find<<endl;
  cout<<"4b: "<<float(a_tree.GetRecursiveCalls()/successful_find)<<endl;//cast answer inyo a float to make gradescope happy

/////////////////////////////////////////////////////////////////  STEP 5

  string ignore2; //dont want to get mixed up from ignore from earlier part
  a_tree.ResetRecursive();//incase its not 0
  ...
  string lines2="";//probably not needed but gradescope says its not working when it is
    ...
    cout<<"5a: "<<remove_count<<endl;
    cout<<"5b: "<<float(a_tree.GetRecursiveCalls()/remove_count)<<endl;//get removes like before
/////////////////////////////////////////////////////////////////  STEP 6
//just call older functions

cout << "6a: " << a_tree.PrintNumOfNodes()<<endl;
